        ...
        NavigationManager.shared.reAuthenticateIfNeeded(context: self) {
            ...
            LoginManager.shared.updateUserExt(userExt: self.uExt!) { (ok) in
                ...
                if ok {
                    ...
                    let alert = UIAlertController(title: NSLocalizedString("SaveFailed", comment: ""), message: NSLocalizedString("EditPersonalFail", comment: ""), preferredStyle: UIAlertControllerStyle.alert)
