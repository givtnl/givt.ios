...
//                    }
    ...
    private func showCancelFeature() {
        if UserDefaults.standard.showCasesByUserID.contains(AppConstants.Showcase.cancelGivt.rawValue) {
            return
        }
        ...
        DispatchQueue.main.async {
            ...
            self.cancelFeature!.show(completion: {
                UserDefaults.standard.showCasesByUserID.append(AppConstants.Showcase.cancelGivt.rawValue)
            })
        }
    }
    
    private func showTaxFeature() {
        if UserDefaults.standard.showCasesByUserID.contains(AppConstants.Showcase.taxOverview.rawValue) || !UserDefaults.standard.hasGivtsInPreviousYear {
            return
        }
        ...
        DispatchQueue.main.async {
            ...
            self.taxOverviewFeature!.show(completion: {
                UserDefaults.standard.showCasesByUserID.append(AppConstants.Showcase.taxOverview.rawValue)
            })
        }
    }
