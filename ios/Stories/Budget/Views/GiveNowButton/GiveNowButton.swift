...
class GiveNowButton : UIButton {
    ...
    private func commonInit() {
        let bundle = Bundle(for: GiveNowButton.self)
        bundle.loadNibNamed("GiveNowButton", owner: self, options: nil)
        shadowAndCorners()
    ...
    func shadowAndCorners() {
        ...
        borderView.backgroundColor = ColorHelper.GivtPurple
