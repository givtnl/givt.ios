...
class SetupRecurringDonationChooseAmountViewController: UIViewController, UIGestureRecognizerDelegate {
    private var mediater: MediaterWithContextProtocol = Mediater.shared

    var input: SetupRecurringDonationOpenChooseAmountRoute!
